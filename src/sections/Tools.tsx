          ...
          {TOOLS.map((t, i) => (
            <article
              ...
              className={`reveal group relative overflow-hidden rounded-[28px] border p-1.5 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${
                t.accent
                  ? 'border-white/25 bg-gradient-to-br from-white/[0.08] via-white/[0.03] to-transparent hover:border-white/40'
            ...
            >
              ...
              >
                <div>
                  ...
                  <h3
                    className={`mt-3 leading-tight font-semibold tracking-tight break-keep text-white ${
                      t.accent
